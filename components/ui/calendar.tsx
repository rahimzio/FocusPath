...
import { DayPicker, DayPickerProvider } from "react-day-picker"; // Importiere DayPickerProvider
...
function Calendar({
  className,
  classNames,
  expenses, // Füge die Ausgaben als Props hinzu
  showOutsideDays = true,
  ...props
}: CalendarProps & { expenses: { name: string; date: string }[] }) {
